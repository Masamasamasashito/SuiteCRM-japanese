...
$mod_strings = array(
    ...
    'LBL_LIST_PHONE' => '電話番号',
    'LBL_LIST_STATE' => '都道府県', //For address fields
    'LBL_MEMBER_OF' => '親会社:',
    ...
    'MSG_SHOW_DUPLICATES' => 'この口座を作成することで重複した口座を作成する可能性があります。以前入力したデータで新しい口座を作成することを継続するために保存をクリックするか、そうでなければキャンセルをクリックしてください。',
    'NTC_DELETE_CONFIRMATION' => '本当にこのレコードを削除してよいですか?',
    'LBL_LIST_FORM_TITLE' => '請求書一覧',
    'LBL_MODULE_NAME' => '請求',
    'LBL_MODULE_TITLE' => '請求書: ホーム',
    'LBL_HOMEPAGE_TITLE' => '私の請求書',
    'LNK_NEW_RECORD' => '請求書を作成',
    'LNK_LIST' => '請求書を表示',
    'LBL_SEARCH_FORM_TITLE' => '請求書を検索',
    'LBL_HISTORY_SUBPANEL_TITLE' => '履歴',
    'LBL_NEW_FORM_TITLE' => '新しい請求書',
    'LBL_TERMS_C' => '期間',
    ...
    'LBL_EXPIRATION' => '有効期限',
    'LBL_INVOICE_NUMBER' => '請求書番号',
    'LBL_OPPORTUNITY' => '商談名',
    'LBL_TEMPLATE_DDOWN_C' => '請求書テンプレート',
    'LBL_STAGE' => '見積ステージ',
    'LBL_TERM' => '支払条件',

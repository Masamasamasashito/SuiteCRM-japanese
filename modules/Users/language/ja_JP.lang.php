...
$mod_strings = array(
    ...
    'LBL_COUNT_COLLAPSED_SUBPANELS' => '折り畳まれたサブパネルのヒントを表示する', // PR 5577
    'LBL_COUNT_COLLAPSED_SUBPANELS_DESCRIPTION' => 'サブパネルが折り畳まれた時、サブパネルが空か、レコードを含むかを示すためのヒントを表示する。',
    'LBL_SUGAR_LOGIN' => 'SuiteCRMユーザーは',
    'LBL_THEME' => 'テーマ',
...
<img src=include/images/suitecrm_login.png style="margin-right: 5px;">
    ...
    'LBL_WIZARD_SCENARIOS_EMPTY_LIST' => '構成されたシナリオがありません',
    ...
    'LBL_SEND_CONFIRM_OPT_IN' => 'オプトイン メールを送信する', // PR 4911
    ...
    'LBL_PROJECT_USERS_1_FROM_PROJECT_TITLE' => 'プロジェクト タイトルからプロジェクト ユーザー',
    'LBL_ROLES' => '役割',
    ...
    'LBL_UNLOCK_USER' => 'ユーザーのロックを解除',  // PR 2897
    'LBL_USER_UNLOCKED_MSG' => 'ロックを解除されたユーザー',  // PR 2897
    'LBL_LANGUAGE' => '言語', // PR 5721
    // for Google Token/Synchronization settings
    'LBL_GOOGLE_API_SETTINGS' => 'Google アカウントの同期', // PR 6146
    'LBL_GOOGLE_API_TOKEN' => 'Google API トークン', // PR 6146
    'LBL_GOOGLE_API_TOKEN_UNCONFIGURED' => '未設定', // PR 6841
    'LBL_GOOGLE_API_TOKEN_CONFIGURED' => '設定済み', // PR 6841
    'LBL_GOOGLE_API_TOKEN_DISABLED' => '無効', // PR 6841
    'LBL_GOOGLE_API_TOKEN_INVALID' => '無効なAuthキー', // PR 6841
    'LBL_GOOGLE_API_TOKEN_HELP' => 'これを使用して、あなたの Google カレンダーにアクセスする SuiteCRM を承認します。これは同期に必要です。完了したら、カレンダーの同期を有効にするチェック ボックスを確認してください。', // PR 6146
    'LBL_GOOGLE_API_TOKEN_BTN' => 'トークンを取得', // PR 6146
    'LBL_GOOGLE_API_TOKEN_BTN_DISABLED' => '無効', // PR 6841
    'LBL_GOOGLE_API_TOKEN_BTN_REAUTHORIZE' => '再承認する', // PR 6841
    'LBL_GOOGLE_API_TOKEN_BTN_AUTHORIZE' => '承認する', // PR 6841
    'LBL_GOOGLE_API_TOKEN_TEXT' => '現在のAPIトークン', // PR 6841
    'LBL_GSYNC_CAL' => 'カレンダーの同期を有効にする', // PR 6146
